...
transcript on
write transcript fir_ramp_transcript

# START MEGAWIZARD INSERT VARIABLES
set top_entity fir_ramp
set timing_resolution "1ps"
set core_version 11.1
set device_family STRATIXIV
set quartus_rootdir /home/admko/altera/11.1/quartus/
...
if {[string match $flow "rtl"] } {
    ...
    if {[file exists fir_ramp.vhd]} {vcom -93 -work work fir_ramp.vhd}
    if {[file exists fir_ramp.v]} {vlog -work work fir_ramp.v}
    vcom -93 -work work fir_ramp_ast.vhd
    vcom -93 -work work fir_ramp_rtl.vhd

    if { [file exists fir_ramp_rtl_wysiwyg.vhd] } {
        vcom -93 -work work fir_ramp_rtl_wysiwyg.vhd
    }
