// megafunction wizard: %FIR Compiler v11.1%
// GENERATION: XML
...
// 			fir_core_ast
// ============================================================
// Generated by FIR Compiler 11.1 [Altera, IP Toolbench 1.3.0 Build 173]
// ************************************************************
...
module fir_core (
	...
	output	[12:0]	ast_source_data;
	output		ast_sink_ready;
	output		ast_source_valid;
	output	[1:0]	ast_source_error;


	fir_core_ast	fir_core_ast_inst(
		.clk(clk),
		.reset_n(reset_n),
		.enable(enable),
...
// Retrieval info: <MEGACORE title="FIR Compiler"  version="11.1"  build="173"  iptb_version="1.3.0 Build 173"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="fir_core_ast" >
...
// Retrieval info:      <PRIVATE name = "coefficient_scaling_factor" value="4096.0"  type="STRING"  enable="0" />
// Retrieval info:      <PRIVATE name = "coefficient_bit_width" value="13"  type="INTEGER"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "input_number_system" value="Signed Binary Fractional"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "input_bit_width" value="10"  type="INTEGER"  enable="0" />
// Retrieval info:      <PRIVATE name = "input_binary_point_position" value="9"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "output_bit_width_method" value="Actual Coefficients"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "output_number_system" value="Signed Binary Fractional"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "output_bit_width" value="13"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "output_bits_right_of_binary_point" value="3"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "output_bits_removed_from_lsb" value="9"  type="INTEGER"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "filename" value="fir_core.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
